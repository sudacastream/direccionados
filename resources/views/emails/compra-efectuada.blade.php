                            ...
                            <tr>
                                <td class="content-cell" style="max-width: 100vw;padding: 32px;">
                                    ...
                                    <p style="position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Hemos recibido tu pedido correctamente. Para continuar con la compra realizá el pago y contestá este correo adjuntando el comprobante de transferencia.
                                    </p>
                                    <p style="position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        El detalle de la compra, el monto total y datos de la cuenta a transferir se te brindan a continuación:
                                    </p>
