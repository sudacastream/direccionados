                                        ...
                                        success: function(data){
                                            ...
                                            else
                                            {
                                                ...
                                                function datos(item)
                                                {
                                                    ...
                                                    html += item.apellidos+', '+item.nombres+' ('+item.dni+')';
                                                    if(item.funcion == 'pastor')
                                                    {
                                                        html += '<span title="Pastor/a" class="inline-flex items-center bg-yellow-100 text-yellow-600 text-xs font-medium p-2.5 ml-2 rounded-full dark:bg-yellow-900 dark:text-yellow-300"><i class="fa-solid fa-user-tie"></i></span>'
                                                    }
                                                    html += '</th><td class="px-2 py-4">';
