                                        ...
                                        success: function(data){
                                            ...
                                            else
                                            {
                                                ...
                                                function datos(item)
                                                {
                                                    ...
                                                    {
                                                        html += '<span title="Pastor/a" class="inline-flex items-center bg-yellow-100 text-yellow-600 text-xs font-medium p-2.5 ml-2 rounded-full"><i class="fa-solid fa-user-tie"></i></span>'
                                                    }
