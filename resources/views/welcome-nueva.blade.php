            ...
            <div class="flex items-center me-4">
                <div class="relative inline-block shrink-0 me-4 pe-4 border-e">
                    ...
                    <span class="absolute top-0 right-0 inline-flex items-center justify-center text-right -translate-x-2 w-5 h-5 bg-greens-500 rounded-full">
                        ...
                        <svg class="w-5 h-5 text-morado" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="w-full h-screen fixed z-40 inset-full flex" id="menu-content" style="background:url(/bg.webp) no-repeat center left;background-size:cover;">
            <nav class="w-full md:w-1/2 flex items-center h-full" id="menu-mobile">
                <ul class="grid uppercase tracking-widest font-press text-white font-semibold mx-auto text-lg text-center md:text-left">
                    ...
                    <li class="hover:bg-transparente px-4 py-3 rounded">
                        <a href="https://web.facebook.com/media/set/?set=a.760049462831275" target="_blank" class="flex">
                            Alojamiento
