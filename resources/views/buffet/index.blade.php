@section('title', 'Buffet - Congreso Direccionados')
<x-app-layout>
    <x-slot name="header">
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data){
                                            ...
                                            else
                                            {
                                                ...
                                                html += '<tr><th scope="col" class="px-2 py-3">Pedido</th><th scope="col" class="px-2 py-3"></th></tr></thead><tbody>';
                                                data.forEach(datos);
                                                function datos(item)
                                                {
                                                    if(item.retiro)
                                                    ...
                                                    html += item.cantidad+' '+cantidad+'</th><td class="px-2 py-4">';
