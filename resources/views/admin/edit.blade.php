            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
                ...
                <div class="p-4" id="listadoToken">
                    ...
                    <div class="relative mt-1">
                        ...
                        <input @isset($token) value="{{ $token }}" @endisset type="text" name="token" required autocomplete="off" id="table-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar por Token Pass">
                    </div>
                    </form>
                    @isset($token)
